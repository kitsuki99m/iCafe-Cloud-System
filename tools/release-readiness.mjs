...
check(/COMPACT_WIDTH = 84/.test(read('apps/customer/electron/main.cjs'))&&/COMPACT_HEIGHT = 22/.test(read('apps/customer/electron/main.cjs'))&&/opacity:0\.8/.test(read('apps/customer/electron/main.cjs'))&&/function applyCompactSessionMode\(\)[\s\S]*setAlwaysOnTop\(false\)/.test(read('apps/customer/electron/main.cjs')),'Customer compact timer must remain extra-small, 80% opacity by default, and non-topmost.')
