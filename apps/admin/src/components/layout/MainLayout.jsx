...
export default function MainLayout({ children }) {
  ...
  return (
    <div className="admin-app-canvas h-screen min-h-0 overflow-hidden p-2 sm:p-3 lg:p-5">
      <div className="admin-shell-frame flex h-full min-h-0 overflow-hidden">
        <aside className="admin-sidebar sticky top-0 z-[120] flex h-full w-[220px] shrink-0 flex-col overflow-visible px-4 py-5 lg:w-[232px] lg:px-5 lg:py-6">
        ...
        <main className="admin-main relative flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
          {!isOverview && <header className="admin-global-header z-[110] flex min-h-[96px] shrink-0 items-center gap-4 px-5 py-3.5 sm:px-6 lg:px-7">
