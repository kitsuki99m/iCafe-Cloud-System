  ...
  return (
    <div className="mb-5 grid grid-cols-2 gap-2">
      ...
      <button
        ...
        className={`flex items-center justify-center gap-1.5 rounded-lg border px-3 py-2.5 text-sm font-semibold transition-colors ${
          role === 'customer' ? 'border-teal/50 bg-teal/10 text-teal-dim' : 'border-surface-line text-slate-soft hover:text-ink-900'
        }`}
      >
    ...
    <div className="flex min-h-screen items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="mb-6 flex flex-col items-center text-center">
          <img src={branding.logoUrl || logo} onError={(event) => { event.currentTarget.src = logo }} alt="" className="mb-3 h-10 w-10" />
          <h1 className="font-display text-xl font-semibold text-ink-900">{branding.cafeName || "Aezakmi Cafe"}</h1>
