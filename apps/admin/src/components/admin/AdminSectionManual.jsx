...
const MANUALS = {
  ...
  Earnings: {
    ...
    steps: [
      { title: 'Choose the reporting period first', items: ['Set the period before comparing totals so you do not mix daily, monthly, or wider ranges.', 'Use Income snapshot for the main totals in the selected window.', 'Remember that wallet-funded usage can be operational context and may not be an additional cash receipt in the same period.'] },
