...
const MANUALS = {
  ...
  Clients: {
    ...
    steps: [
      { title: 'Register and pair each PC', items: ['Add a PC with a clear label/number. Cloud stations map their LAN address automatically after pairing; local-only Café Edge stations use a full IP address.', 'For Cloud stations, generate the pairing information and complete pairing on the Customer Station.', 'Do not create duplicate logical PCs for the same physical computer; fix its metadata instead.'] },
  ...
  Earnings: {
    ...
    steps: [
      { title: 'Choose the reporting period first', items: ['Set the period before comparing totals so you do not mix daily, monthly, or wider ranges.', 'Use Income snapshot for the main totals in the selected window.', 'Paid starting-wallet loads and wallet top-ups are included in gross when received. Wallet activity is shown separately for reconciliation and must not be added to gross a second time.'] },
