...
import { AlertTriangle, Clock3, LockKeyhole, Monitor, MonitorCheck, MonitorPlay, Plus, Search, WifiOff, Wrench } from 'lucide-react'
      ...
      <section className="clients-floor-workspace">
        ...
        <div className="mt-4">
          {pcs.length ? (
            ...
            <AdminEmptyState icon={Monitor} title="No PC clients registered" description="Add the laptop/PC using its LAN IP address. Customer Stations identify themselves by that IP." action={<Button icon={Plus} variant="primary" size="sm" onClick={() => setPcFormOpen(true)}>Add PC</Button>}/>
          )}
        </div>
      </section>
