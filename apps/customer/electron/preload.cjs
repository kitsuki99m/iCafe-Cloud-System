...
contextBridge.exposeInMainWorld('aezakmiClient', {
  ...
  getStationLauncherConfig:() => ipcRenderer.invoke('client:get-station-launcher-config'),
  setStationLauncherConfig:config => ipcRenderer.invoke('client:set-station-launcher-config', config),
  browseExecutable:() => ipcRenderer.invoke('client:browse-executable'),
  extractExeIcon:exePath => ipcRenderer.invoke('client:extract-exe-icon', exePath),
  ...
  showMiniDashboard:() => ipcRenderer.invoke('client:show-mini-dashboard'),
  showFullscreenDashboard:() => ipcRenderer.invoke('client:show-fullscreen-dashboard'),
