...
export default function ServerConnectionModal({ open, onClose, initialConfig = null }) {
  ...
  return (
    <Modal
      ...
      description="Change which cafe server this station uses without rebuilding. Tests stop after 4 seconds, and you can close the window while a test is being cancelled."
      maxWidth="max-w-lg"
      busy={isSaving}
      zIndexClass="z-[900]"
      footer={(
